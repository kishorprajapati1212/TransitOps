...
const create = [
  ...
  body('contact_number').optional({ checkFalsy: true }).isLength({ max: 30 }).withMessage('contact_number too long'),
...
const update = [
  ...
  body('contact_number').optional({ checkFalsy: true }).isLength({ max: 30 }),
