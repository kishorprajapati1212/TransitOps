-- ============================================================
-- TransitOps — Initial Migration (001)
-- This is the versioned migration that creates the full schema.
-- It is identical to schema.sql and can be applied directly via psql:
--     psql "$DATABASE_URL" -f migrations/001_initial_migration.sql
-- or through the runner:  npm run db:migrate
-- ============================================================
